let perguntas = [
    ...
    [
        ...
        {
            pergunta: 'DESENVOLVIMENTO 1 <br> <span> 2.1 CONECTIVOS </span>',
            options: [
        ...
        {
            pergunta: 'DESENVOLVIMENTO 2 <BR> <span> 3.1 CONECTIVOS </span>',
            options: [
                'ALÉM DISSO',
                'ADEMAIS',
                'SOMA-SE A ISSO',
        ...
        {
            pergunta: 'DESENVOLVIMENTO 2 <br> <span> 3.4 COMENTÁRIO CONECTIVO </span>',
            options: [
                'DESSE MODO',
                'ASSIM',
                'DESSA FORMA',
        ...
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.1 CONECTIVOS </span>',
            options: [
                'PORTANTO',
                'DESTARTE',
                'EM SUMA'             
        ...
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.4 AÇÃO </span>',
            options: [
                'DEVE CRIAR',
                'DEVE AMPLIAR',
                'DEVE INFORMAR',
        ...
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.5 MEIO MODO </span>',
            options: [
        ...
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.6 FINALIDADE </span>',
            options: [
                'A FIM DE AMENIZAR',
                'A FIM DE DIMINUIR',
                'A FIM DE ATENUAR',
    ...
    [
        {
            ...
            options: [
                ...
                'FILME “A COR PÚRPUTA”',
                'DOCUMENTÁRIO “O SILÊNCIO DOS INOCENTES”',
        ...
        },
        {
            ...
            options: [
                ...
                'A NATURALIZAÇÃO DE QUE A MULHER É UM SER MAIS FRÁGIL'
            ]       
        },
        {
            pergunta: 'DESENVOLVIMENTO 1 <br> <span> 2.1 CONECTIVOS </span>',
        ...
        },
        {
            pergunta: 'DESENVOLVIMENTO 1 <br> <span> 2.2 RETOMADA DA TESE </span>',
            options: [
                'A AUSÊNCIA DE MEDIDAS PROTETIVAS E FICAZES DO GOVERNO.',
                'AS DIFERENCAS BIOLÓGICAS RESULTARAM ENTRE HOMENS E MULHERES RESULTARAM EM DESIGUALDES.',
                'OBJETIVAÇÃO DA MULHER',
            ]        
        },
        {
            pergunta: 'DESENVOLVIMENTO 1 <br> <span> 2.3 EXEMPLIFICAÇÃO </span>',
            options: [
                '“A CULPA DA VIOLÊNCIA CONTRA A MULHER É DA SOCIEDADE MACHISTA EM QUE VIVEMOS E DA FALTA DE LEIS MAIS SEVERAS PARA ESSES TIPOS DE CRIME (HERBERT ALEXANDRE GALDINO PEREIRA)',
                'EM BRIGA DE HOMEM E MULHER NÃO SE METE A COLHER',
                '”A VIOLÊNCIA, SEJA QUAL FOR A MANEIRA COMO ELA SE MANIFESTA, É SEMPRE UMA DERROTA.” JEAN-PAUL SARTRE',
                'CONVENÇÃO DE BELÉM DO PARÁ, AFIRMA QUE A VIOLÊNCIA CONTRA A MULHER CONSTITUI VIOLAÇÃO DOS DIREITOS HUMANOS',
                'LEI MARIA DA PENHA'
            ]
        },
        {
        ...
        },
        {
            ...
            options: [
                ...
                'GRANDE DIFUSORA DE INFORMAÇÃO E VEÍCULO FORMADOR DE OPINIÃO',
                'ENTIDADE RESPONSÁVEL PELA EDUCAÇÃO FORMAL',
                'ÓRGÃO RESPONSÁVEL PELA ARTICULAÇÃO INTERMINISTERIAL E INTERSETORIAL DAS POLÍTICAS DE PROMOÇÃO E PROTEÇÃO AOS DIREITOS HUMANOS NO BRASIL'            
            ]
        },
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.4 AÇÃO </span>',
        ...
        },
        {
            ...
            options: [
                ...
                'POR MEIO DE CAMPANHAS PUBLICITÁRIAS',
                'POR MEIO DE DEBATES',
                'POR MEIO DE MEDIDAS PROTETORAS IMEDIATAS'                   
            ]
        },
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.6 FINALIDADE </span>',
    ...
    [
        ...
        },
        {
            ...
            options: [
                ...
                'CIDADÃOS NÃO POLITIZADOS',
                'CONSUMO DE MASSA'
            ]        
        },
        {
            pergunta: 'DESENVOLVIMENTO 2 <br> <span> 2.3 EXEMPLIFICAÇÃO </span>',
            options: [
                'A RESPONSABILIDADE SOCIAL E A PRESERVAÇÃO AMBIENTAL SIGNIFICA UM COMPROMISSO COM A VIDA. “O HOMEM É O LOBO DO HOMEM”. —  THOMAS HOBBES',
                '"O HOMEM NÃO É NADA ALÉM DAQUILO QUE A EDUCAÇÃO FAZ DELE." (KANT)                NA NATUREZA NADA SE CRIA, NADA SE PERDE, TUDO SE TRANFORMA  (ANTOINE LAVORSIER)',               
            ]
        },
        {
            pergunta: 'DESENVOLVIMENTO 1 <br> <span> 2.4 COMENTÁRIO - CONECTIVO </span>',
        ...
        {
            pergunta: 'DESENVOLVIMENTO 2 <br> <span> 3.2 EXEMPLIFICAÇÃO </span>',
            options: [
                'A RESPONSABILIDADE SOCIAL E A PRESERVAÇÃO AMBIENTAL SIGNIFICA UM COMPROMISSO COM A VIDA. (JOÃO BOSCO SILVA)',
                'O HOMEM É O LOBO DO HOMEM.“ —  THOMAS HOBBES',
                '"O HOMEM NÃO É NADA ALÉM DAQUILO QUE A EDUCAÇÃO FAZ DELE." (KANT)',
                'NA NATUREZA NADA SE CRIA, NADA SE PERDE, TUDO SE TRANFORMA  (ANTOINE LAVORSIER)'            
            ]
        },   
        {
            pergunta: 'DESENVOLVIMENTO 2 <br> <span> 3.4 COMENTÁRIO CONECTIVO </span>',
        ...
        },
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.3 DETALHAMENTO DO AGENTE </span>',
            options: [
                'ÓRGÃO RESPONSÁVEL PELAS POLÍTICAS PÚBLICAS NA ÁREA DO MEIO AMBIENTE',
                'ÓRGÃO RESPONSÁVEL PELAS POLÍTICAS PÚBLICAS NA ÁREA DA EDUCACIONAL',
                'GRANDE DIFUSORA DE INFORMAÇÃO E VEÍCULO FORMADOR DE OPINIÃO',
                'ENTIDADE RESPONSÁVEL PELA EDUCAÇÃO FORMAL',
    ...
    [
        ...
        },
        {
            ...
            options: [
                ...
                'PROFESSOR LUIZ FELIPE PONDRÉ: “A CULTURA DO CANCELAMENTO ESTÁ ENRAIZADA NUMA CARACTERÍSTICA DO SER HUMANO. O SER HUMANO GOSTA DE JOGAR PEDRA NOS OUTROS. ELE GOSTA PORQUE, NESSE MOMENTO, É QUASE COMO SE ELE SENTISSE QUE É PURO',
                'FAMOSOS QUE FORAM CANCELADOS: NEYMAR - ANITA - FELIPE NETO - KAROL CONKÁ',
            ]
        },
        {
            pergunta: 'DESENVOLVIMENTO 1 <br> <span> 2.4 COMENTÁRIO CONECTIVO </span>',
        ...
        },
        {
            pergunta: 'CONCLUSÃO <br> <span> 4.3 DETALHAMENTO DO AGENTE </span>',
            options: [
                'ÓRGÃO RESPONSÁVEL POR POLÍTICAS PÚBLICAS NA ÁREA DA EDUCAÇÃO',
                'GRANDE DIFUSORA DE INFORMAÇÃO E VEÍCULO FORMADOR DE OPINIÃO',
                'ENTIDADE RESPONSÁVEL PELA EDUCAÇÃO FORMAL',
